...
cronecho( "Got " . count( $filesTodo ) . " queries to do:" );
cronecho( "Moving queries to doing..." );
...
cronecho( "Got " . count( $tasks ) . " tasks to do:" );
cronecho( "Doing Tasks:" );
